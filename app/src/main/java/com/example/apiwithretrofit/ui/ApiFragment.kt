...
import com.example.apiwithretrofit.recyclerview.ApiRecyclerView
...
class ApiFragment : Fragment() {
    ...
    private lateinit var postAdapter: ApiRecyclerView
    ...
    fun setupRecyclerView(posts:List<Source>) = binding.rvapi.apply {
        postAdapter = ApiRecyclerView(posts,viewModel)
        adapter = postAdapter
